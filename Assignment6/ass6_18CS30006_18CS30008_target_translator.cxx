...
string asmfilename="ass6_18CS30006_18CS30008_";		// asm file name
string inputfile="ass6_18CS30006_18CS30008_test";		// input file name
...
void genasmHelper(int ac, char* av[]) {
...
//				asmfile << "movq\t" << table->ar[arg1] << "(%rbp), "<<"%rax" << endl;
				...
				table = globalTable->lookup(result)->nested;
				asmfile << "\taddq\t$" << table->table.back().offset+24 << ", %rsp"<<endl;
